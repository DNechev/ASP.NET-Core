...
using Eventures.Models.ModelValidation;
...
namespace Eventures
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IValidator<EventCreateBindingModel>, EventsDateValidation>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseStatusCodePagesWithRedirects("/Error/ErrorMessage");
